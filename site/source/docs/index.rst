...
------------------------------------------------------------------------------------------------------------------------------------------------------------------
2022.10. / IPEC 特定非営利法人プロフェッショナルイングリッシュコミュニケーション協会

.. __: https://www.ipec.or.jp/column/2022/programming-python-english.html

.. figure:: images/ipec-interview-top.*
   :target: https://www.ipec.or.jp/column/2022/programming-python-english.html


- 本書で伝えているのは、プログラマーになるための全般的で普遍的な知識やスキルと、継続できない人向けに諦めずに頑張り続けるための工夫やアドバイス。
- Pythonを選んだのは、Pythonでのプログラミングが楽しかったから。
- 実際に何かを作って、完成までの流れを把握することで、より実践的に学習できる。仮にAIがコードを書く時代が来ても、中身を知っておくのは大事。
